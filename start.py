...
def dark():
        ...
        dark_format_auto(C+'\t['+W+'1'+C+']'+W+' SPAM WA NUKLIR SAMPE NANGIS!'+C+' ( '+H+'ON ✅'+C+' )')
        dark_format_auto(C+'\t['+W+'2'+C+']'+W+' SPAM WA '+M+'PHD'+C+' ( '+H+'ON ✅'+C+' )')
